...
import { IconFlame, IconCode, IconRocket, IconHammer } from "@tabler/icons-react";
      ...
      content: (
        <div>
          ...
          <p className="mb-8 text-sm text-gray-300 leading-relaxed">
            Forged and launched revolutionary UI systems from the depths of creativity, each
            component tempered by passion and refined through countless iterations.
          </p>
      ...
      content: (
        <div>
          ...
          <p className="mb-4 text-sm text-gray-300 leading-relaxed">
            In the early flames of creation, every line of code was a battle against mediocrity.
            Each design forged with purpose, each component crafted with soul.
          </p>
          <p className="mb-8 text-sm text-gray-300 leading-relaxed">
            These are not mere templates - they are weapons of mass creation, tools forged in the
            fire of relentless iteration and unwavering vision.
          </p>
          <div className="grid grid-cols-2 gap-4">
            <div className="group relative">
              <Image
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="mb-4 text-sm text-gray-300 leading-relaxed">
            The first sparks of creation ignited. Learning the ancient arts of web development, each
            tutorial a step closer to mastery.
          </p>
          <p className="mb-8 text-sm text-gray-300 leading-relaxed">
            From humble beginnings to ambitious dreams - the forge was being built, one line of code
            at a time.
          </p>
          <div className="grid grid-cols-2 gap-4">
            <div className="group relative">
              <div className="h-20 md:h-44 lg:h-60 w-full rounded-lg bg-gradient-to-br from-purple-900/30 to-pink-900/30 border border-zinc-700 hover:border-purple-500 transition-all duration-300 group-hover:scale-105 shadow-lg shadow-purple-900/20 flex items-center justify-center">
                <span className="text-purple-300 text-sm font-medium">First HTML Page</span>
              </div>
            </div>
            <div className="group relative">
              <div className="h-20 md:h-44 lg:h-60 w-full rounded-lg bg-gradient-to-br from-pink-900/30 to-red-900/30 border border-zinc-700 hover:border-pink-500 transition-all duration-300 group-hover:scale-105 shadow-lg shadow-pink-900/20 flex items-center justify-center">
                <span className="text-pink-300 text-sm font-medium">CSS Mastery</span>
              </div>
            </div>
            <div className="group relative">
              <div className="h-20 md:h-44 lg:h-60 w-full rounded-lg bg-gradient-to-br from-indigo-900/30 to-purple-900/30 border border-zinc-700 hover:border-indigo-500 transition-all duration-300 group-hover:scale-105 shadow-lg shadow-indigo-900/20 flex items-center justify-center">
                <span className="text-indigo-300 text-sm font-medium">JavaScript Journey</span>
              </div>
            </div>
            <div className="group relative">
              <div className="h-20 md:h-44 lg:h-60 w-full rounded-lg bg-gradient-to-br from-red-900/30 to-orange-900/30 border border-zinc-700 hover:border-red-500 transition-all duration-300 group-hover:scale-105 shadow-lg shadow-red-900/20 flex items-center justify-center">
                <span className="text-red-300 text-sm font-medium">First Project</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="relative z-10 py-16">
        <div className="max-w-4xl mx-auto px-4 mb-12">
          <div className="text-center">
            <h2 className="text-4xl md:text-6xl font-bold text-white mb-4">The Forge Chronicles</h2>
            ...
            <p className="text-gray-300 text-lg max-w-2xl mx-auto">
              A journey through fire and code, where every milestone was forged in the flames of
              determination.
            </p>
          </div>
        </div>
