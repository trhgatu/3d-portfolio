...
export function AwakeningSection() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative min-h-screen flex flex-col items-center justify-center py-24 px-6 bg-black overflow-visible selection:bg-red-500 selection:text-white z-10"
    >
      ...
      <div className="awakening-content relative z-30 flex flex-col items-center text-center max-w-4xl gap-8">
        ...
        <p className="font-space-mono text-gray-400 text-lg leading-relaxed max-w-2xl px-4">
          <span className="text-white">Creation is violent.</span> It requires tearing apart silence
          to make sound. Breaking emptiness to build structure. That first line of code wasn&apos;t
          just logic—it was an act of defiance against the void.
        </p>
      </div>
