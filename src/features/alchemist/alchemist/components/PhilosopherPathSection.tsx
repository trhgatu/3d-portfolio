...
export function PhilosopherPathSection() {
  ...
  return (
    ...
    <section
      ref={containerRef}
      className="relative min-h-screen flex flex-col items-center justify-center py-24 px-6 overflow-hidden bg-black -mt-24 pt-24"
    >
      ...
      <div className="relative z-20 container mx-auto flex flex-col items-center text-center">
        ...
        <div className="vision-text max-w-2xl font-space-mono text-gray-300 text-lg leading-relaxed mb-16">
          ...
          <p className="text-sm text-gray-400">
            My journey is not towards a destination, but towards a deeper understanding of the art
            itself.
          </p>
        </div>
