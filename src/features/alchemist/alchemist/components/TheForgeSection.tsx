...
const PHILOSOPHY_STEPS = [
  {
    ...
    description:
      "To create something of value, something of equal value must be lost. I trade sleepless nights and endless focus for systems that endure.",
    element: "Earth",
  },
  {
    phase: "Transmutation",
    ...
    description:
      "Code is not static. It is a living, breathing entity. I specialize in transforming raw data into meaningful, interactive experiences.",
    element: "Fire",
  },
  {
    phase: "Flow State",
    ...
    description:
      "Adaptability is the only true strength. Like water, my solutions take the shape of the problem, seamless and unbreakable.",
    element: "Water",
  },
  {
    phase: "Aether",
    ...
    description:
      "The user experience is the spirit of the application. It cannot be seen, only felt. It is the magic that binds logic to emotion.",
    element: "Air",
  },
];
...
export function TheForgeSection() {
  ...
  return (
    ...
    <section
      ref={containerRef}
      className="relative min-h-[150vh] py-32 overflow-hidden bg-black -mt-64 pt-96"
    >
      {/* Forge Background */}
      ...
      <div className="relative z-10 container mx-auto px-6">
        ...
        <div className="relative max-w-4xl mx-auto flex flex-col gap-24">
          ...
          {PHILOSOPHY_STEPS.map((step, index) => (
            <div
              key={index}
              className={`forge-step relative flex flex-col md:flex-row gap-8 items-start md:items-center ${
                index % 2 === 0
                  ? "md:flex-row-reverse text-left md:text-left"
