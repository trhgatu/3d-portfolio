...
export function MasteryPanel() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative py-32 flex items-center justify-center min-h-screen bg-black"
    >
        ...
        <div className="max-w-4xl mx-auto border-y border-white/20 py-16 px-8 relative bg-black/50 backdrop-blur-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-8">
            {SKILLS.map((skill, index) => (
              <div
                key={index}
                className="flex items-center justify-between group border-b border-dashed border-white/10 pb-4 hover:border-white/40 transition-colors"
              >
