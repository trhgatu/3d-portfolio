...
export const FoundationListItem = ({ foundation }: { foundation: Project }) => (
  ...
  >
    <div className="relative w-20 h-20 rounded-lg overflow-hidden flex-shrink-0">
      <Image src={foundation.thumbnail || ""} alt={foundation.name} fill className="object-cover" />
    ...
    <div className="flex-1">
      <div className="flex items-center gap-2 mb-1">
        ...
        <span className="px-2 py-1 text-xs bg-orange-600 text-white rounded-full">foundation</span>
