  ...
  <div className="relative flex flex-1 w-full h-full min-h-[10rem] rounded-xl overflow-hidden bg-black">
    ...
    <div className="absolute inset-0 z-10">
      <Image
        ...
        style={{
          maskImage: "linear-gradient(90deg, transparent 0%, #fff 18%, #fff 82%, transparent 100%)",
          WebkitMaskImage:
    ...
    <div className="absolute inset-0 flex items-center justify-center p-4 z-20">
      <div className="text-center">
        <div className={`mx-auto h-12 w-12 ${iconColor} mb-2 drop-shadow-lg`}>{icon}</div>
        <span className="text-white text-sm font-medium drop-shadow-lg">{subtitle}</span>
      </div>
    </div>
