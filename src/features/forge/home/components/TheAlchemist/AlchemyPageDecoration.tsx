...
export function AlchemyPageDecoration() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-12 md:left-16 top-[65%] text-neutral-800/80 text-base font-bilbo italic leading-relaxed select-none z-[15] max-w-[80px] md:max-w-[100px]">
