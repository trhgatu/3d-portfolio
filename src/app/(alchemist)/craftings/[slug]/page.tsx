...
// import { usePublicProjectBySlug } from '@/features/alchemist/craftings/hooks'; // Unused with mock data
...
const ARTIFACTS = [
  {
    ...
    year: "2023",
    description:
      "A 3D configurator for custom katanas using Three.js and WebGL. Users can customize every aspect of the blade, from the hamon pattern to the tsuba design, in a real-time physically based rendering environment.",
  ...
  },
  {
    ...
    year: "2024",
    description:
      "Node.js distributed system for processing alchemical data streams. Handles real-time transmutation requests with high throughput and eventual consistency guarantees.",
  ...
  },
  {
    ...
    year: "2024",
    description:
      "React Native app for deciphering ancient runic scripts via camera. Uses on-device ML models to identify and translate elder futhark runes in real-time.",
  ...
  },
  {
    ...
    year: "2025",
    description:
      "Unity prototype exploring void mechanics in a 2D platformer. Players manipulate gravity and dimension shifting to traverse a broken world.",
    thumbnail: "/assets/images/craftings/bg-sumi-e-snow.png",
    icon: "/assets/images/craftings/icon-blade.png",
    category: "Game Dev",
    status: "Prototype",
  ...
  },
  {
    ...
    year: "2023",
    description:
      "Decentralized ledger for tracking guild transactions seamlessly. Ensures transparency in the underworld economy using smart contracts.",
    thumbnail: "/assets/images/craftings/alchemist_forge_bg.png",
    icon: "/assets/images/craftings/icon-alchemy.png",
    category: "Web3",
    status: "Archived",
  ...
  },
  {
    ...
    year: "2025",
    description:
      "Environmental sensors connected to a central weather shrine. Broadcasts ambient data to a dashboard for adjusting alchemy parameters.",
...
export default function CraftingDetailPage() {
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-screen font-serif bg-black text-white overflow-x-hidden selection:bg-red-900 selection:text-white"
    >
      {/* --- HERO SECTION --- */}
        ...
        <div className="container mx-auto px-6 md:px-12 max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-16">
            ...
            <div className="md:col-span-7 space-y-12">
              <div>
                <h2 className="text-3xl font-kings text-white mb-6 border-b border-white/10 pb-4 inline-block">
                  The Chronicle
                </h2>
                <div className="prose prose-invert prose-lg text-gray-400 font-serif leading-loose">
                  ...
                  <p className="mt-4">
                    An artifact forged in the depths of the codebase. It represents a streamlined
                    approach to {item.type?.toLowerCase() || "development"}, utilizing ancient
                    techniques merged with modern alchemy.
                  </p>
                  <p>
                    Primary directive: To solve complexity through elegant design and robust
                    architecture.
                  </p>
                </div>
              </div>
              ...
              {/* Tech Stack Sigils */}
              <div>
                <h3 className="text-xl font-space-mono text-red-500 mb-6 uppercase tracking-widest">
                  Alchemy Components
                </h3>
                <div className="flex flex-wrap gap-4">
                  {item.tech?.map((tech) => (
                    <div
                      key={tech.name}
                      className="group relative px-6 py-3 border border-white/10 bg-white/5 hover:border-red-500/50 transition-all duration-300 backdrop-blur-sm cursor-default"
                    >
            ...
            <div className="md:col-span-5 space-y-12 md:sticky md:top-32 h-fit">
              ...
              <div className="p-8 border border-white/10 bg-neutral-900/50 backdrop-blur-md relative overflow-hidden group">
                ...
                <h3 className="font-space-mono text-xs text-white/40 uppercase tracking-widest mb-6 text-center">
                  Artifact Status
                </h3>
                ...
                <div className="flex justify-between items-center py-4 border-b border-white/5">
                  ...
                  <span className="text-red-400 font-space-mono text-sm uppercase">
                ...
                {item.link && (
                  ...
                  >
                    ...
                    <div className="absolute inset-[1px] bg-black flex items-center justify-center gap-3 group-hover:bg-black/90 transition-colors">
                      ...
                      <span className="font-kings text-2xl text-white pt-1">
                        Initiate Protocol (Demo)
                      </span>
                    </div>
                  </a>
                )}
      ...
      <section className="py-24 border-t border-white/5 bg-neutral-900/20">
        <div className="container mx-auto px-6 max-w-7xl">
          <h2 className="text-center font-space-mono text-xs text-white/30 uppercase tracking-[0.3em] mb-12">
            Visual Records
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="aspect-video relative grayscale hover:grayscale-0 transition-all duration-700 cursor-zoom-in border border-white/5">
              {item.thumbnail && (
                <Image src={item.thumbnail} alt="record 1" fill className="object-cover" />
              )}
              <div className="absolute bottom-4 left-4 font-space-mono text-[10px] text-white/50 bg-black/50 px-2 py-1">
                FIG. 01
              </div>
            </div>
